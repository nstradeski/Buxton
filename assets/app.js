...
const SHOPPING = [
  {
    ...
    items: [
      ...
      { id: 'sh-mushrooms-chestnut', text: '250g chestnut mushrooms (Sichuan vegan "mince")' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sh-tofu', text: '1.8 kg tofu — 2 × silken/firm for Wed Ma Po + 2 × firm for Sat stir-fry' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sh-rice-noodles', text: '500g flat rice noodles (Sat Asian)' },
...
const PACKING = [
  {
    ...
    items: [
      ...
      { id: 'garlic', text: 'Garlic bulbs (lots — Mexican + 2 × Asian)' },
